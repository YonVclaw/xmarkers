...
def main():
    ...
    print("""
  ######################################
  # XMARK Development Environment Setup #
  ######################################

  This script will create your XMARK dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your XMARK project folder:
    [Arma 3 installation directory]\\{} => XMARK project folder
    P:\\{}                              => XMARK project folder
